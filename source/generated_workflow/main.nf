...
include { HISAT2_ALIGN ; HISAT2_ALIGN  } from '../../../ninon/description_prototype/annotated_nextflow_modules/Hisat2_align.nf'
...
HISAT2_ALIGN(params.genome, params.annotation_gtf)
DEXSEQ_ANNOTATION(params.annotation_gtf)
TRIMGALORE(read_pairs_ch)
HISAT2_ALIGN(TRIMGALORE.out.preprocessed_reads, HISAT2_ALIGN.out.index, params.annotation_gtf)
